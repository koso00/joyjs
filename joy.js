  ...
  function definestick(left,top)
  {
    if (bodyset == false){
      ...
      refresh = setInterval(function(){
        ...
        {
         if ((deg <= 45) || (deg > 315)) {direction = "right"; $(zone).trigger("joystickright")}
         if ((deg > 45)&&(deg <= 135)) {direction = "up";$(zone).trigger("joystickup")}
         if ((deg > 135)&&(deg <= 225)) {direction = "left";$(zone).trigger("joystickleft")}
         if ((deg > 225)&&(deg <= 315)) {direction = "down";$(zone).trigger("joystickdown")}
       }
       },1000/60)
